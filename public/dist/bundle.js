...
const Key = "AIzaSyAunexxIOtKCOZPExg5z25pyLHOVDN79d8";
function searchAddressHandler(event) {
    event.preventDefault();
    const enteredAddress = addressInput.value;
    axios__WEBPACK_IMPORTED_MODULE_0___default().get(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURI(enteredAddress)}&key=${Key}`)
        .then((response) => {
